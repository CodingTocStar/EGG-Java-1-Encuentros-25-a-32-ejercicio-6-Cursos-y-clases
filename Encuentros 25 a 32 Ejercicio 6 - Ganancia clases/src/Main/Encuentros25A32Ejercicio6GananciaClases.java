 ...
 * @author MiriamNahuel
 */
public class Encuentros25A32Ejercicio6GananciaClases {

    public static void main(String[] args) {

        CursoServicio cursoService = new CursoServicio();
        Curso curso1 = cursoService.crearCurso();
        
        System.out.println("La ganancia semanal del curso es: " + cursoService.calcularGananciaSemanal(curso1));
